...
(cl:in-package visual_patrol-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <SetTarget-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetTarget-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name visual_patrol-srv:<SetTarget-request> is deprecated: use visual_patrol-srv:SetTarget-request instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <SetTarget-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader visual_patrol-srv:data-val is deprecated.  Use visual_patrol-srv:data instead.")
  (data m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetTarget-request>)))
  ...
  "visual_patrol/SetTargetRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetTarget-request)))
  "Returns string type for a service object of type 'SetTarget-request"
  "visual_patrol/SetTargetRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SetTarget-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetTarget-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name visual_patrol-srv:<SetTarget-response> is deprecated: use visual_patrol-srv:SetTarget-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <SetTarget-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader visual_patrol-srv:success-val is deprecated.  Use visual_patrol-srv:success instead.")
  (success m))

(cl:ensure-generic-function 'message-val :lambda-list '(m))
(cl:defmethod message-val ((m <SetTarget-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader visual_patrol-srv:message-val is deprecated.  Use visual_patrol-srv:message instead.")
  (message m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetTarget-response>)))
  ...
  "visual_patrol/SetTargetResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetTarget-response)))
  "Returns string type for a service object of type 'SetTarget-response"
  "visual_patrol/SetTargetResponse")
