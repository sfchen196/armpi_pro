...
(cl:in-package color_tracking-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <SetTarget-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetTarget-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name color_tracking-srv:<SetTarget-request> is deprecated: use color_tracking-srv:SetTarget-request instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <SetTarget-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader color_tracking-srv:data-val is deprecated.  Use color_tracking-srv:data instead.")
  (data m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetTarget-request>)))
  ...
  "color_tracking/SetTargetRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetTarget-request)))
  "Returns string type for a service object of type 'SetTarget-request"
  "color_tracking/SetTargetRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SetTarget-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetTarget-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name color_tracking-srv:<SetTarget-response> is deprecated: use color_tracking-srv:SetTarget-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <SetTarget-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader color_tracking-srv:success-val is deprecated.  Use color_tracking-srv:success instead.")
  (success m))

(cl:ensure-generic-function 'message-val :lambda-list '(m))
(cl:defmethod message-val ((m <SetTarget-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader color_tracking-srv:message-val is deprecated.  Use color_tracking-srv:message instead.")
  (message m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetTarget-response>)))
  ...
  "color_tracking/SetTargetResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetTarget-response)))
  "Returns string type for a service object of type 'SetTarget-response"
  "color_tracking/SetTargetResponse")
