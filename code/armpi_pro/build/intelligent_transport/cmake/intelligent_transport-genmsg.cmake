...
get_filename_component(_filename "/home/ubuntu/armpi_pro/src/intelligent_transport/srv/SetTarget.srv" NAME_WE)
add_custom_target(_intelligent_transport_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "intelligent_transport" "/home/ubuntu/armpi_pro/src/intelligent_transport/srv/SetTarget.srv" ""
)
...
_generate_srv_cpp(intelligent_transport
  "/home/ubuntu/armpi_pro/src/intelligent_transport/srv/SetTarget.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/intelligent_transport)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/intelligent_transport\")")
  # install generated code
  install(
